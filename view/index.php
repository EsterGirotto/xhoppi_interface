...
<html lang="pt-BR">
  ...
  <body>
    ...
    <div class="carousel-wrapper">
      <div id="carouselExampleIndicators" class="carousel slide">
        ...
        <div class="carousel-inner">
          <div class="carousel-item active"><img src="../assets/img/xhopii_1.png" class="d-block w-100" alt="..." /></div>
          <div class="carousel-item"><img src="../assets/img/xhopii_2.png" class="d-block w-100" alt="..." /></div>
          <div class="carousel-item"><img src="../assets/img/xhopii_3.png" class="d-block w-100" alt="..." /></div>
        </div>
    ...
    <div class="imagem"><img src="../assets/img/xhopii_4.png" /></div>
